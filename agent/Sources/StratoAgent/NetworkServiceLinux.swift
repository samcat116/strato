...
extension NetworkServiceLinux: LoadBalancerActuator {
    private static var loadBalancerIDKey: String { "strato-load-balancer-id" }
    private static var loadBalancerGenerationKey: String { "strato-generation" }
    private static var loadBalancerDisplayNameKey: String { "strato-display-name" }
    private static var loadBalancerListenerIDKey: String { "strato-listener-id" }
    ...
    private static func loadBalancerExternalIDs(
        _ desired: DesiredLoadBalancer
    ) -> [String: String] {
        [
    ...
    private static func makeLoadBalancerRow(
        _ desired: DesiredLoadBalancer,
        healthChecks: [String],
    ...
    private static func loadBalancerRow(
