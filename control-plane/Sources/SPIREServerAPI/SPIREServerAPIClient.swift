        ...
        case .mtls(let identityProvider):
            ...
            return .tls(
                .mTLS(
                    ...
                    // SPIRE server TLS certificates carry a SPIFFE URI SAN,
                    // not the Service DNS name; chain verification against the
                    // trust domain's CA is what establishes trust.
