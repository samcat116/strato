...
CREATE TABLE public.volumes (
    ...
    block_mode text DEFAULT 'conservative'::text NOT NULL,
    applied_block_policy jsonb,
    observed_size_bytes bigint,
    environment text DEFAULT 'development'::text NOT NULL,
    ...
    CONSTRAINT ck_volumes_block_mode_enum CHECK ((block_mode = ANY (ARRAY['conservative'::text, 'direct'::text, 'cachedShared'::text]))),
