...
enum IAMRoleRegistry {
    ...
    /// `vm:runCommand` is likewise excluded: a safe HTTP method never turns
    /// guest execution into a read. These are the defect STR-115 exists to
    /// close, not collateral.
