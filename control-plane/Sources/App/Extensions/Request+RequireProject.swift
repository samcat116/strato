...
extension Request {
    ...
    ///
    /// Distinct from the two create-side resolvers, which authorize a create's
    /// *target* project — and, for VMs and sandboxes, resolve an environment —
    /// rather than reading a project out of the path:
