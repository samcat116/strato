...
struct QuotaComplianceServiceTests {
    ...
    func testComplianceInfoMath() {
        ...
        let usage = QuotaUsage(vcpus: 5, memoryGB: 4.0, storageGB: 25.0, vms: 2, sandboxes: 0, volumes: 0, networks: 0)
    ...
    func testComplianceInfoZeroUsage() {
        ...
        let usage = QuotaUsage(vcpus: 0, memoryGB: 0, storageGB: 0, vms: 0, sandboxes: 0, volumes: 0, networks: 0)
        let info = QuotaComplianceService.complianceInfo(for: quota, actualUsage: usage)
