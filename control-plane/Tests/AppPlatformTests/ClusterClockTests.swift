...
struct ClusterClockTests {
    ...
    func noReplicaClockDefaultsInDurableInterfaces() throws {
        ...
        let files = [
            ...
            "Migrations/AddNetworkFabricObservations.swift",
            "Controllers/NetworkController.swift",
            "Services/AgentMaintenanceLoop.swift",
            "Services/DesiredStateGenerationWriter.swift",
            "Services/ObservedStateApplier.swift",
            "Services/ResourceMutation.swift",
            "Services/SecurityGroupSiteConvergence.swift",
