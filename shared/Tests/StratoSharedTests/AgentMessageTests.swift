...
struct AgentMessageTests {
    ...
    func agentUpdateURLRedaction() {
        ...
        #expect(
            DesiredAgentUpdate.redactURL("https://user:pass@mirror.internal/strato.tar.gz")
        ...
        #expect(DesiredAgentUpdate.redactURL(plain) == plain)
        ...
        #expect(!DesiredAgentUpdate.redactURL("://tok en@x?secret=1").contains("secret"))
    }
