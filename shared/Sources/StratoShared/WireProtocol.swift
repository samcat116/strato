...
public enum WireProtocol {
    /// The only wire/schema version this build accepts. Version 43 carries the
    /// per-NIC DHCP and link-local service inputs needed to render NoCloud-net
    /// network-config from `InstanceMetadata` (STR-60).
