...
public enum WireProtocol {
    /// The only wire/schema version this build accepts. Version 51 adds the
    /// agent's complete optional whole-disk inventory (STR-156). Version 50
    /// preserved stdout/stderr identity on guest-exec output for captured VM
    /// commands (STR-79). Version 49 added the agent metadata-service capability used
    ...
    public static let currentVersion = 51
