...
public enum WireProtocol {
    /// The only wire/schema version this build accepts. Version 54 distinguishes
    /// interactive and recorded guest-exec sessions and adds level-triggered
    /// recorded-session state replay and acknowledgement (STR-260). Version 53 adds
    /// ordered, network-scoped ACL desired state (STR-33). Version 52 adds
    /// the agent's complete optional whole-disk inventory (STR-156). Version 51 replaces
