...
public enum WireProtocol {
    /// The only wire/schema version this build accepts. Version 59 carries the
    /// requested and agent-applied QEMU block-device policy. Version 58 removes
    ...
    public static let currentVersion = 59
