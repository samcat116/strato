...
public enum WireProtocol {
    /// The only wire/schema version this build accepts. Version 60 carries the
    /// requested and agent-applied QEMU block-device policy. Version 59 adds
    /// explicitly available host and per-workload resource telemetry. Version 58 removes
