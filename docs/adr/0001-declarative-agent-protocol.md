...
8. **Snapshots and checkpoints as desired artifacts** (retention design
   ...
   *Extended by STR-19 (wire v35).* Volumes gain absolute I/O ceilings —
   ...
   *Implemented by STR-270 (wire v59).* QEMU agents now advertise an explicit,
   ...
   unsupported and is rejected before placement or update. The earlier notes
   above describe STR-19's intentionally incomplete first stage.
