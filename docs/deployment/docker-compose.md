...
| `DATABASE_MAX_CONNECTIONS` | `20` | Maximum native PostgreSQL connections opened by each control-plane replica. |
| `DATABASE_CONNECTION_ACQUIRE_TIMEOUT_MS` | `10000` | Maximum wait in milliseconds for a pooled PostgreSQL connection before the operation fails. |
