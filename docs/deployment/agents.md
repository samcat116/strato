...
| `SPIFFE_JWT_BUNDLE_REFRESH_INTERVAL` | How often the JWT authorities are refreshed (seconds). Rotation is also picked up on demand when a token names an unknown key. | `300` |
