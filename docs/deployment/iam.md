...
The top level IAM object is an organization. This is where SSO and users are stored at. Within an org, there are projects. A project is a grouping of cloud resources. Projects can be organized within an organization in folders, which nest arbitrarily.
